...
class AuthController:
    ...
    def sign_in(self, body):
        try:
            ...
            return {
                'message': f'No se encontró el usuario: {username}'
            },HTTPStatus.NOT_FOUND
        except Exception as e:
            return {
                'message': 'Ocurrrió un error',
                'error': str(e)
            }, HTTPStatus.INTERNAL_SERVER_ERROR
    
    def refresh_token(self, identity):
        #como generamos nuestro nuevo access_token
        try:
    ...
    def password_reset(self, body):
        try:
            ...
            if record:
                ...
                return {
                    'message': f'Se envió un correo con la nueva contraseña'
                }, HTTPStatus.OK
            return {
                'message': f'No se encontró el usuario con el correo: {email}'
            },HTTPStatus.NOT_FOUND
        except Exception as e:
